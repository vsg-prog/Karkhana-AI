...
Triggers tab of Nitya's Command Center.`;
...
export function SettingsModal({ config, onClose, initialSection }: SettingsModalProps) {
  ...
  // Talk (Realtime Nitya) is gated on the OpenAI key — read the live presence
  // boolean so the Realtime Nitya section can show its enabled/disabled status.
          ...
          {changeHome ? (
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 16, overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                {([
                  ['move', 'Move existing data (recommended)', "Copy this Karkhana Workspace's hive (every agent, memory, task) and the semantic-memory palace into the new folder. The old folder is left untouched as a backup you can delete later."],
                  ['fresh', 'Start fresh', 'Point Karkhana Workspace at the new (empty) folder. Your existing data stays in the old folder, simply unused.']
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1, fontSize: 15, lineHeight: '22px', color: 'var(--cth-ink-700)' }}>
                  This permanently erases all of Nitya's memories and the entire hive,
            ...
            <>
              <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
                ...
                <div style={{
                  ...
                  {activeSection === 'Agents & Models' && (
                    <>
                      <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                          <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                            Every newly spawned Claude agent (Nitya included) starts on this model unless picked per-agent.
                    ...
                    <>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                            ...
                            <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                              Pipe a Slack channel's messages straight into Nitya's queue.
                            </span>
                          </div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        ...
                        <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                          ...
                          schema — edit that in the Triggers tab of Nitya's Command Center, where the history
                  ...
                  {/* VOICE — Free Flow dictation + Realtime Nitya (v0.3.4: its own tab) */}
                  {activeSection === 'Voice' && (
                    <>
                      ...
                      {/* Realtime Nitya — voice device selection (rt-8) */}
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                        <div style={{
                          fontFamily: 'var(--cth-font-display)', fontSize: 8, lineHeight: '12px',
                          color: 'var(--cth-ink-500)', textTransform: 'uppercase', marginBottom: 2
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                          <span style={{ fontSize: 13, lineHeight: '20px', color: 'var(--cth-ink-900)' }}>
                            Voice chat with Nitya
                          </span>
                          <span style={{ fontSize: 12, lineHeight: '16px', color: 'var(--cth-ink-500)' }}>
                            Talk to the orchestrator in real time. Toggle it on from Nitya's tab; choose which
                        ...
                        <div style={{
                          ...
                          <span style={{ fontSize: 12, lineHeight: '17px', color: 'var(--cth-ink-700)' }}>
                            Talking to Nitya runs on OpenAI&rsquo;s Realtime API — speech in, speech out, over a
                          ...
                          <span style={{
                            ...
                            {openAiVoiceNote || (hasOpenAiKey
                              ? 'Key saved — Talk is ready. Start it from Nitya’s card.'
                  ...
                  {activeSection === 'General' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                      ...
                      <p style={{ margin: 0, fontSize: 13, lineHeight: '20px', color: 'var(--cth-ink-700)' }}>
                        Reset wipes Nitya's memories, the entire hive (every agent, message,
